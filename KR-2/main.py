...
print(colored('Викиди CO2 з 1960 по 2018 рік', 'blue').center(250))
print("------------------------------")
...
fig_emissions_year = px.line(data_frame=co2_df_tr, x=co2_df_tr.index, y=['World'], markers=True,
                             title='Викиди CO2 в світі за період 1960-2018')
fig_emissions_year.layout.xaxis.title = "Роки"
fig_emissions_year.layout.yaxis.title = "Рівень CO2 в повітрі"
fig_emissions_year.show()
# ------------------------------

#
print(colored("Таблиця з даними 2", 'green'))
co2_data_file.head()
...
fig_emissions_year_5.layout.xaxis.title = "Рівень CO2 в повітрі"
